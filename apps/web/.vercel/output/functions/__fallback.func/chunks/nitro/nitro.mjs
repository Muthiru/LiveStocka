import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};globalThis.__timing__.logStart('Load chunks/nitro/nitro');import http from 'node:http';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "supabaseUrl": "https://aautrwrugmsbbcmamexc.supabase.co",
    "supabaseAnonKey": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFhdXRyd3J1Z21zYmJjbWFtZXhjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Njk4NzI4MzgsImV4cCI6MjA4NTQ0ODgzOH0.46il5YzYfIbzReiJHd56o1qGiJwUJqDqqnxnxBCLObk"
  },
  "icon": {
...
const _svuJaUiuHobeegDyatHkL6HaafHpmXkF8OdXqETCmZQ = defineNitroPlugin((nitro) => {
...
const _ZLeHe0Hz391Ua6oG3DlQS5hN1xxridxro6HxiuHT3o = defineNitroPlugin((nitro) => {
...
const plugins = [
  _svuJaUiuHobeegDyatHkL6HaafHpmXkF8OdXqETCmZQ,
_ZLeHe0Hz391Ua6oG3DlQS5hN1xxridxro6HxiuHT3o
];
...
const _lIwjs4 = defineCachedEventHandler(async (event) => {
...
const _lazy_X1LSuV = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_X1LSuV, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _lIwjs4, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_X1LSuV, lazy: true, middleware: false, method: undefined }
];
